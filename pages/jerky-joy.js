...
const CHAR = '#141310', SPICE = '#C79A3A', KRAFT = '#B8892F', CREAM = '#F6F1E6'
const INK = '#141310', MUTED = '#8A8175', GREEN = '#3E7C4F', BORDER = '#E6DBC8', AMBER = '#C79A3A', RED = '#C03A22'
const CARDBG = '#FFFDF9'
const BIZ = 'Jerky Joy'
...
export default function JerkyJoy() {
      ...
      <div className="jm-shell">
        ...
        <aside className="jm-side">
          <div style={{ padding: '2px 8px 16px' }}>
            <div style={{ ...big, fontSize: '25px', letterSpacing: '-0.5px', lineHeight: 1 }}>
              <span style={{ color: SPICE }}>Jerky</span> <span style={{ color: '#E4C066' }}>Joy</span>
            </div>
            <div style={{ ...lbl, color: '#8A7A66', marginTop: '6px', fontSize: '9px', letterSpacing: '0.04em' }}>#1 Kosher Tasting Jerky on Earth</div>
        ...
        <main className="jm-main">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', marginBottom: '22px' }}>
            <div>
              <div style={{ ...lbl, color: SPICE }}>Jerky Joy</div>
