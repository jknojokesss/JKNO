...
const ORDERS = [
  { id: 'G-001', firstName: 'Amanda',   lastName: 'Torres',     date: '2026-08-10', event: '2026-09-28', items: [{ desc: 'Rose Gold Gown – Style 4812', qty: 1, price: 1200 }, { desc: 'Alterations', qty: 1, price: 180, taxable: false }], payments: [{ amount: 600, method: 'Check', date: '2026-08-10' }], alterations: true, alterationsDone: false, alterationsDue: '2026-09-20', notes: 'Needs hem shortened 2 inches' },
  { id: 'G-002', firstName: 'Jessica',  lastName: 'Park',       date: '2026-08-14', event: '2026-10-05', items: [{ desc: 'Ivory A-Line – Style 2291', qty: 1, price: 980 }], payments: [{ amount: 490, method: 'Zelle', date: '2026-08-14' }], alterations: false, alterationsDone: false, notes: '' },
  { id: 'G-003', firstName: 'Nicole',   lastName: 'Rivera',     date: '2026-08-20', event: '2026-09-15', items: [{ desc: 'Navy Formal – Style 3340', qty: 1, price: 1450 }, { desc: 'Alterations', qty: 1, price: 220, taxable: false }], payments: [{ amount: 1450, method: 'Card', date: '2026-08-20' }, { amount: 220, method: 'Cash', date: '2026-09-01' }], alterations: true, alterationsDone: true, notes: '' },
  { id: 'G-004', firstName: 'Stephanie',lastName: 'Chen',       date: '2026-09-01', event: '2026-10-12', items: [{ desc: 'Blush Satin – Style 5510', qty: 1, price: 1650 }], payments: [{ amount: 500, method: 'Check', date: '2026-09-01' }], alterations: false, alterationsDone: false, notes: 'Bride — handle with priority' },
  { id: 'G-005', firstName: 'Danielle', lastName: 'Murphy',     date: '2026-09-05', event: '2026-10-20', items: [{ desc: 'Champagne Gown – Style 1190', qty: 1, price: 875 }, { desc: 'Alterations', qty: 1, price: 150, taxable: false }], payments: [], alterations: true, alterationsDone: false, alterationsDue: '2026-10-10', notes: '' },
  { id: 'G-006', firstName: 'Priya',    lastName: 'Patel',      date: '2026-09-10', event: '2026-11-03', items: [{ desc: 'Silver Beaded – Style 7721', qty: 1, price: 2100 }], payments: [{ amount: 1000, method: 'Zelle', date: '2026-09-10' }], alterations: false, alterationsDone: false, notes: '' },
  { id: 'G-007', firstName: 'Lauren',   lastName: 'Mitchell',   date: '2026-07-15', event: '2026-09-01', items: [{ desc: 'Burgundy Gown – Style 6603', qty: 1, price: 1100 }, { desc: 'Alterations', qty: 1, price: 200, taxable: false }], payments: [{ amount: 1100, method: 'Check', date: '2026-07-15' }, { amount: 200, method: 'Cash', date: '2026-08-20' }], alterations: true, alterationsDone: true, notes: '' },
  { id: 'G-008', firstName: 'Maria',    lastName: 'Santos',     date: '2026-07-20', event: '2026-08-30', items: [{ desc: 'Emerald Gown – Style 2280', qty: 1, price: 1350 }], payments: [{ amount: 1350, method: 'Card', date: '2026-07-20' }], alterations: false, alterationsDone: false, notes: '' },
]
      ...
      <div className="shell">
        ...
        <main className="main">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
              <div style={{ fontFamily: mono, fontSize: '9px', color: MUTED, letterSpacing: '.1em', textTransform: 'uppercase', marginBottom: '3px' }}>September 2026</div>
