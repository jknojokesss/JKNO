...
// ── Theme ────────────────────────────────────────────────────────────────────
const NAVY = '#152028', GOLD = '#0E7C66', CREAM = '#F2F4F6'
const INK = '#12181E', MUTED = '#6B7580', GREEN = '#0E7C66', RED = '#B42318', AMBER = '#B45309'
const BORDER = '#D7DDE3', CARDBG = '#FFFFFF'
const MONO = "'IBM Plex Mono', monospace"
const BIZ = 'Ashford Trading'
...
const BRANDS = ['Vesper', 'Northline', 'Solara', 'Meridian', 'Fieldwatch', 'Lumen', 'Cove', 'Arcadia', 'Pike']
...
const SEED_POS = [
  { id: uid(), poNo: 'PO-001', supplier: 'Harbor Optics HK', origin: 'Hong Kong', brand: 'Vesper', units: 24, unitCost: 180, total: 4320, ordered: '2026-06-01', eta: '2026-06-20', status: 'arrived', billNo: 'BILL-001', billPaid: true, shipper: 'DHL Express', customs: 'Bay Clearance Group', notes: '', landedCosts: [{ id: uid(), type: 'Freight', amount: 480 }, { id: uid(), type: 'Duties', amount: 648 }, { id: uid(), type: 'Delivery', amount: 120 }] },
  { id: uid(), poNo: 'PO-002', supplier: 'Alpen Accessories GmbH', origin: 'Italy', brand: 'Northline', units: 18, unitCost: 220, total: 3960, ordered: '2026-06-05', eta: '2026-06-28', status: 'arrived', billNo: 'BILL-002', billPaid: false, shipper: 'FedEx International', customs: 'Bay Clearance Group', notes: '', landedCosts: [{ id: uid(), type: 'Freight', amount: 360 }, { id: uid(), type: 'Duties', amount: 594 }] },
  { id: uid(), poNo: 'PO-003', supplier: 'Lago Frames SRL', origin: 'Italy', brand: 'Solara', units: 60, unitCost: 48, total: 2880, ordered: '2026-06-10', eta: '2026-06-30', status: 'in_transit', billNo: null, billPaid: false, shipper: 'FedEx International', customs: 'Bay Clearance Group', notes: '', landedCosts: [] },
  { id: uid(), poNo: 'PO-004', supplier: 'Prairie Wholesale Co.', origin: 'USA', brand: 'Meridian', units: 30, unitCost: 165, total: 4950, ordered: '2026-06-12', eta: '2026-07-08', status: 'in_transit', billNo: null, billPaid: false, shipper: 'UPS Freight', customs: '', notes: '', landedCosts: [] },
  { id: uid(), poNo: 'PO-005', supplier: 'Harbor Optics HK', origin: 'Hong Kong', brand: 'Fieldwatch', units: 48, unitCost: 95, total: 4560, ordered: '2026-06-15', eta: '2026-07-15', status: 'ordered', billNo: null, billPaid: false, shipper: 'DHL Express', customs: 'Bay Clearance Group', notes: '', landedCosts: [] },
  { id: uid(), poNo: 'PO-006', supplier: 'Thames Softgoods Ltd', origin: 'UK', brand: 'Arcadia', units: 12, unitCost: 310, total: 3720, ordered: '2026-06-08', eta: '2026-06-25', status: 'delayed', billNo: null, billPaid: false, shipper: 'DHL Express', customs: 'Bay Clearance Group', notes: 'Customs hold — estimated 1-week delay', landedCosts: [] },
  { id: uid(), poNo: 'PO-007', supplier: 'Pacific Rim Eyewear', origin: 'Japan', brand: 'Cove', units: 36, unitCost: 72, total: 2592, ordered: '2026-06-18', eta: '2026-07-20', status: 'ordered', billNo: null, billPaid: false, shipper: 'Japan Post EMS', customs: 'Bay Clearance Group', notes: '', landedCosts: [] },
]

const SEED_INVOICES = [
  { id: uid(), invNo: 'INV-001', customer: 'Crown Street Watches', brand: 'Vesper', units: 12, unitPrice: 340, total: 4080, date: '2026-06-22', due: '2026-07-22', paid: true, paidDate: '2026-06-22', notes: '' },
  { id: uid(), invNo: 'INV-002', customer: 'Oak & Thread Retail', brand: 'Vesper', units: 6, unitPrice: 340, total: 2040, date: '2026-06-21', due: '2026-07-21', paid: true, paidDate: '2026-06-23', notes: '' },
  { id: uid(), invNo: 'INV-003', customer: 'Coastline Accessories', brand: 'Northline', units: 8, unitPrice: 420, total: 3360, date: '2026-06-20', due: '2026-07-20', paid: false, paidDate: null, notes: '' },
  { id: uid(), invNo: 'INV-004', customer: 'Beacon Timepieces', brand: 'Meridian', units: 15, unitPrice: 310, total: 4650, date: '2026-06-23', due: '2026-07-23', paid: false, paidDate: null, notes: 'Pre-sold — goods arriving July 8' },
  { id: uid(), invNo: 'INV-005', customer: 'Canal Eyewear Co.', brand: 'Solara', units: 30, unitPrice: 95, total: 2850, date: '2026-06-23', due: '2026-07-23', paid: false, paidDate: null, notes: 'Pre-sold — goods in transit' },
]
...
export default function AshfordTrading() {
  ...
  const exportQB = () => {
    ...
    const a = document.createElement('a'); a.href = 'data:text/csv;charset=utf-8,'+encodeURIComponent(csv); a.download = 'ashford-trading-qb-export.csv'; a.click()
  }
  ...
  return (
    <>
      <Head>
        <title>Ashford Trading — Sample Portal</title>
...
.ash-shell{display:flex;min-height:100vh}
.ash-side{width:230px;flex-shrink:0;background:${NAVY};display:flex;flex-direction:column;padding:22px 14px;position:sticky;top:0;height:100vh}
.ash-nav{display:flex;flex-direction:column;gap:3px;flex:1}
.ash-btn{display:block;width:100%;text-align:left;padding:11px 14px;border-radius:10px;border:none;background:transparent;color:#8A9BB8;font-family:'Inter',sans-serif;font-size:14px;font-weight:500;cursor:pointer}
.ash-btn:hover{background:rgba(255,255,255,.08);color:#fff}
.ash-main{flex:1;min-width:0;max-width:1180px;padding:24px 30px 60px}
@media(max-width:860px){.ash-shell{flex-direction:column}.ash-side{width:auto;height:auto;position:static;padding:14px 12px}.ash-nav{flex-direction:row;overflow-x:auto;gap:6px;padding-bottom:4px}.ash-btn{width:auto;padding:8px 15px;border-radius:18px;background:rgba(255,255,255,.07)}.ash-main{padding:18px 16px 52px}}`}</style>
      </Head>
      ...
      <div className="ash-shell">
        ...
        <aside className="ash-side">
          <div style={{ padding: '2px 8px 20px' }}>
            <div style={{ fontSize: '22px', fontWeight: 800, color: '#fff', letterSpacing: '-0.5px', lineHeight: 1 }}>ASH</div>
          ...
          <nav className="ash-nav">
            {TABS.map(([id, label]) => (
              <button key={id} className="ash-btn" onClick={() => { setTab(id); setExpanded(null) }}
        ...
        <main className="ash-main">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', marginBottom: '24px' }}>
            <div>
              <div style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', color: GOLD, textTransform: 'uppercase' }}>Ashford Trading</div>
