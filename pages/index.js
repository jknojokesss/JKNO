...
export default function Landing() {
  ...
  const scrollFeatures = () => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })
        ...
        <section className="m-dark-band">
          <div className="m-wrap m-band">
            <div className="m-band__hero">
              ...
              <button type="button" className="m-btn m-btn--primary m-btn--pop" onClick={scrollFeatures}>
                What we build ↓
              </button>
            </div>

            <HomeFeatures live={heroLive} />
          </div>
        </section>
