...
const SEED_POS = [
  { id: uid(), poNo: 'PO-001', supplier: 'HK Watch Imports Ltd', origin: 'Hong Kong', brand: 'Michele', units: 24, unitCost: 180, total: 4320, ordered: '2026-09-01', eta: '2026-09-20', status: 'arrived', billNo: 'BILL-001', billPaid: true, shipper: 'DHL Express', customs: 'A&M Customs Brokers', notes: '', landedCosts: [{ id: uid(), type: 'Freight', amount: 480 }, { id: uid(), type: 'Duties', amount: 648 }, { id: uid(), type: 'Delivery', amount: 120 }] },
  { id: uid(), poNo: 'PO-002', supplier: 'Euro Luxury SA', origin: 'Italy', brand: 'Armani', units: 18, unitCost: 220, total: 3960, ordered: '2026-09-05', eta: '2026-09-28', status: 'arrived', billNo: 'BILL-002', billPaid: false, shipper: 'FedEx International', customs: 'A&M Customs Brokers', notes: '', landedCosts: [{ id: uid(), type: 'Freight', amount: 360 }, { id: uid(), type: 'Duties', amount: 594 }] },
  { id: uid(), poNo: 'PO-003', supplier: 'Optical World Italia', origin: 'Italy', brand: 'Ray-Ban', units: 60, unitCost: 48, total: 2880, ordered: '2026-09-10', eta: '2026-09-30', status: 'in_transit', billNo: null, billPaid: false, shipper: 'FedEx International', customs: 'A&M Customs Brokers', notes: '', landedCosts: [] },
  { id: uid(), poNo: 'PO-004', supplier: 'MK Global Dist.', origin: 'USA', brand: 'Michael Kors', units: 30, unitCost: 165, total: 4950, ordered: '2026-09-12', eta: '2026-10-08', status: 'in_transit', billNo: null, billPaid: false, shipper: 'UPS Freight', customs: '', notes: '', landedCosts: [] },
  { id: uid(), poNo: 'PO-005', supplier: 'HK Watch Imports Ltd', origin: 'Hong Kong', brand: 'Citizen', units: 48, unitCost: 95, total: 4560, ordered: '2026-09-15', eta: '2026-10-15', status: 'ordered', billNo: null, billPaid: false, shipper: 'DHL Express', customs: 'A&M Customs Brokers', notes: '', landedCosts: [] },
  { id: uid(), poNo: 'PO-006', supplier: 'Burberry Wholesale EU', origin: 'UK', brand: 'Burberry', units: 12, unitCost: 310, total: 3720, ordered: '2026-09-08', eta: '2026-09-25', status: 'delayed', billNo: null, billPaid: false, shipper: 'DHL Express', customs: 'A&M Customs Brokers', notes: 'Customs hold in London — estimated 1-week delay', landedCosts: [] },
  { id: uid(), poNo: 'PO-007', supplier: 'Pacific Sun Optics', origin: 'Japan', brand: 'Mau Jim', units: 36, unitCost: 72, total: 2592, ordered: '2026-09-18', eta: '2026-10-20', status: 'ordered', billNo: null, billPaid: false, shipper: 'Japan Post EMS', customs: 'A&M Customs Brokers', notes: '', landedCosts: [] },
]

const SEED_INVOICES = [
  { id: uid(), invNo: 'INV-001', customer: 'Luxury Watch Boutique NJ', brand: 'Michele', units: 12, unitPrice: 340, total: 4080, date: '2026-09-22', due: '2026-10-22', paid: true, paidDate: '2026-09-22', notes: '' },
  { id: uid(), invNo: 'INV-002', customer: 'Style Hub Lakewood', brand: 'Michele', units: 6, unitPrice: 340, total: 2040, date: '2026-09-21', due: '2026-10-21', paid: true, paidDate: '2026-09-23', notes: '' },
  { id: uid(), invNo: 'INV-003', customer: 'Riviera Accessories', brand: 'Armani', units: 8, unitPrice: 420, total: 3360, date: '2026-09-20', due: '2026-10-20', paid: false, paidDate: null, notes: '' },
  { id: uid(), invNo: 'INV-004', customer: 'Prestige Watches Brooklyn', brand: 'Michael Kors', units: 15, unitPrice: 310, total: 4650, date: '2026-09-23', due: '2026-10-23', paid: false, paidDate: null, notes: 'Pre-sold — goods arriving July 8' },
  { id: uid(), invNo: 'INV-005', customer: 'Fifth Ave Eyewear', brand: 'Ray-Ban', units: 30, unitPrice: 95, total: 2850, date: '2026-09-23', due: '2026-10-23', paid: false, paidDate: null, notes: 'Pre-sold — goods in transit' },
]

// 12-month P&L history (Sep matches the live invoices/POs total)
const MONTH_PL = [
