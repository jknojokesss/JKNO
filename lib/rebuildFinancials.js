...
// gl_transactions + account_categories classification. Called after a GL import
// (new ledger) and after a Chart of Accounts import (new classification), so
// either one keeps the whole financials tab consistent.
