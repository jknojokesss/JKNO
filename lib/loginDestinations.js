...
const DESTINATIONS = [
  {
    label: 'Reydel Tire',
    // Portal UI lives in jknojokesss/reydel under /reydel-tire. Different
    // origin, so a session made here would not carry over — we hand off at
    // the login screen and Thomas types his password there. Swap this host
    // when reydel.jknojokes.com is attached.
    emails: ['thomashart1984@gmail.com', 'thomashart84@gmail.com'],
    url: 'https://reydel.vercel.app/reydel-tire/login',
  },
  {
    label: 'Lew Imports',
    ...
    // Shop UI lives in jknojokesss/gowns. Same Supabase project as JKNO.
    domain: '@lewimports.com',
    url: 'https://gowns-nine.vercel.app/gowns',
  },
  {
    label: 'Jerky Munch',
