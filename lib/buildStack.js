...
export const BUILD_STACK = [
  ...
  },
  {
    ...
    items: [
      ...
      { t: 'Ten-second crew log', d: 'The field logs a day from a phone — and it lands in QuickBooks already coded to the job.', tag: 'DEMO', href: '/riverbend-fence' },
      { t: 'WIP schedule & buyer package', d: 'Over/under billing, retainage, normalized EBITDA with add-backs — print-ready for a lender or a buyer.', tag: 'DEMO', href: '/riverstone-roofing' },
      { t: '13-week cash flow', d: 'What is actually landing in the bank, with slow-paying claims and retainage aged in their own column.', tag: 'DEMO', href: '/riverstone-roofing' },
    ],
  },
]
