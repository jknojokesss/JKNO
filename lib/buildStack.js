...
export const BUILD_STACK = [
  {
    ...
    blurb: 'API work on the systems you already run: QBO, register, vendor portal, bank. Pulled into your portal every night.',
    items: [
  ...
  },
  {
    ...
    blurb: 'Margin per ticket, inventory on hand, open AR. The views QuickBooks doesn\u2019t ship.',
    items: [
  ...
  },
  {
    ...
    blurb: 'Each demo started as one owner\u2019s problem. Yours gets wired the same way, not copied from a template.',
    items: [
...
export const BUSINESS_TYPES = [
  ...
  { label: 'Anyone on QuickBooks', detail: 'One screen instead of ten reports' },
]
