...
// Numbers are latest-month (Sep) figures; the 12-month arrays run Oct→Sep.
...
export const INDUSTRIES = [
  {
    ...
    expLines: [
      { n: 'Parts & tires (COGS)', a: 26400, tx: [['9/26', 'ATD — American Tire Dist.', 9840], ['9/19', 'WorldPac parts order', 4210], ['9/12', 'NAPA Auto Parts', 2890]] },
      { n: 'Payroll', a: 14800, tx: [['9/30', 'Payroll run — 2 techs + advisor', 7400], ['9/15', 'Payroll run', 7400]] },
      { n: 'Rent', a: 4200, tx: [['9/1', 'Shoreline Plaza LLC', 4200]] },
      { n: 'Shop supplies', a: 1900, tx: [['9/22', 'Grainger', 640], ['9/9', 'Uline', 720], ['9/4', 'Local hardware', 540]] },
      { n: 'Insurance', a: 1600, tx: [['9/1', 'Garage keepers policy', 1600]] },
      { n: 'Software & misc', a: 2400, tx: [['9/1', 'Shop management software', 380], ['9/14', 'Card processing fees', 1120], ['9/28', 'Uniforms & laundry', 900]] },
    ],
    extraKpi: { k: 'CARS THROUGH THE SHOP', v: '312', sub: 'this month · avg $219/RO' },
    insights: [
      'Tires are 44% of your revenue but only ~18% margin — repairs and service carry the profit. September\'s mix shifted 3 points toward tires, which is why profit felt flat while the shop was slammed.',
      ...
      'That $9,840 ATD order in late September: quoting WorldPac against every $5K+ parts order is worth ~$1,000/month on a 4% swing.',
    ],
    extras: [
      {
        tab: 'Supplier Orders',
  ...
  },
  {
    ...
    expLines: [
      { n: 'Equipment & parts', a: 34200, tx: [['9/24', 'Ferguson HVAC Supply', 12400], ['9/17', 'Johnstone Supply', 8900], ['9/6', 'Carrier distributor — 2 condensers', 9200]] },
      { n: 'Payroll', a: 21500, tx: [['9/30', 'Payroll — 3 techs + office', 10750], ['9/15', 'Payroll run', 10750]] },
      { n: 'Vehicles & fuel', a: 4800, tx: [['9/28', 'Fleet fuel card', 2140], ['9/20', 'Van 2 — brake service', 890], ['9/8', 'Fleet fuel card', 1770]] },
      { n: 'Rent & warehouse', a: 3600, tx: [['9/1', 'Industrial park unit 4B', 3600]] },
      { n: 'Insurance', a: 2900, tx: [['9/1', 'GL + workers comp', 2900]] },
      { n: 'Marketing', a: 1900, tx: [['9/15', 'Google Local Services ads', 1250], ['9/3', 'Yard signs & truck decals', 650]] },
    ],
    extraKpi: { k: 'MAINTENANCE PLANS', v: '118', sub: 'recurring revenue base' },
    insights: [
      'September did $92.6K — install season. But look at October: $52.4K. Banking ~$8K/month now is what covers winter payroll without sweating it.',
      ...
      'Equipment ate 37% of September spend, and installs are running roughly 2× the margin of service calls per crew-day — every extra install day is worth ~$1,900 in profit.',
    ],
    extras: [
      {
        tab: 'Quote Builder',
  ...
  },
  {
    ...
    expLines: [
      { n: 'Materials & fixtures', a: 22800, tx: [['9/25', 'Ferguson Plumbing Supply', 8400], ['9/18', 'Home Depot Pro', 3200], ['9/10', 'AO Smith — 4 water heaters', 4900]] },
      { n: 'Payroll', a: 19600, tx: [['9/30', 'Payroll — 3 plumbers + apprentice', 9800], ['9/15', 'Payroll run', 9800]] },
      { n: 'Vehicles & fuel', a: 4300, tx: [['9/27', 'Fleet fuel', 1980], ['9/12', 'Van 1 — tires', 840], ['9/5', 'Fleet fuel', 1480]] },
      { n: 'Insurance', a: 2700, tx: [['9/1', 'GL + workers comp', 2700]] },
      { n: 'Permits & inspections', a: 1400, tx: [['9/20', 'Township permits ×3', 860], ['9/6', 'Backflow certifications', 540]] },
      { n: 'Rent & misc', a: 3300, tx: [['9/1', 'Shop rent', 2200], ['9/14', 'Answering service', 420], ['9/1', 'Software & GPS', 680]] },
    ],
    extraKpi: { k: 'AVG SERVICE TICKET', v: '$342', sub: 'up from $305 last quarter' },
    insights: [
      'Service & repair is 52% of September revenue and runs roughly double the per-hour margin of remodel work — protect those emergency slots.',
      '14 water heaters in September at ~$800 installed. Attaching a heater quote to every service call over $300 converts about 1 in 9 — that\'s 4 more heaters a month sitting in your own call log.',
    ...
    extras: [
      {
        ...
        modules: [{
          ...
          segs: [
            { name: 'EMERGENCY', hot: true, lines: [['Jobs (Sep)', '31'], ['Avg ticket', '$612'], ['Labor hrs/job', '2.1']], foot: ['Margin', '58%'] },
            { name: 'SCHEDULED SERVICE', lines: [['Jobs (Sep)', '64'], ['Avg ticket', '$342'], ['Labor hrs/job', '2.4']], foot: ['Margin', '39%'] },
            { name: 'REMODEL / ROUGH-IN', lines: [['Jobs (Sep)', '6'], ['Avg ticket', '$4,100'], ['Labor hrs/job', '38']], foot: ['Margin', '31%'] },
          ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Materials & fixtures', a: 17900, tx: [['9/26', 'Cooper Electric Supply', 7200], ['9/16', 'Graybar', 5400], ['9/8', 'Home Depot Pro', 2100]] },
      { n: 'Payroll', a: 16800, tx: [['9/30', 'Payroll — 2 journeymen + helper', 8400], ['9/15', 'Payroll run', 8400]] },
      { n: 'Vehicles & fuel', a: 3600, tx: [['9/28', 'Fleet fuel', 1650], ['9/11', 'Van registration + tolls', 480], ['9/4', 'Fleet fuel', 1470]] },
      { n: 'Insurance', a: 2400, tx: [['9/1', 'GL + workers comp', 2400]] },
      { n: 'Tools & equipment', a: 1500, tx: [['9/19', 'Milwaukee — replacement kit', 890], ['9/7', 'Test equipment calibration', 610]] },
      { n: 'Rent & misc', a: 2300, tx: [['9/1', 'Shop rent', 1500], ['9/1', 'Software & phones', 800]] },
    ],
    ...
    insights: [
      ...
      'EV chargers: 6 in September, best margin in the shop, and growing. Put it on every invoice footer — your own customer list is the cheapest lead source you have.',
        ...
        modules: [
          {
            ...
            segs: [
              { name: 'RESIDENTIAL', lines: [['Invoices (Sep)', '24'], ['Avg days to pay', '2'], ['Outstanding', '$1,850']], foot: ['Share of revenue', '44%'] },
              { name: 'COMMERCIAL', hot: true, lines: [['Invoices (Sep)', '11'], ['Avg days to pay', '47'], ['Outstanding', '$28,400']], foot: ['Share of revenue', '40%'] },
              { name: 'PANELS & EV', lines: [['Invoices (Sep)', '9'], ['Avg days to pay', '8'], ['Outstanding', '$3,200']], foot: ['Share of revenue', '16%'] },
            ],
          ...
          },
          {
            ...
            rows: [
              ['R. Feldman — Tesla wall connector', '9/25', '$1,250', '$520', '58%', 'Referral'],
              ['M. Grasso — Level 2 + subpanel', '9/18', '$2,100', '$980', '53%', 'Invoice footer'],
              ['Bayside condo — shared charger', '9/11', '$3,800', '$1,900', '50%', 'Property manager'],
              ['K. Brooks — Level 2', '9/6', '$1,180', '$540', '54%', 'Google'],
            ],
            note: '6 installs in September, 4 referral sources. Put it on every invoice footer — your customer list is the cheapest ad you own.',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Payroll & crews', a: 21600, tx: [['9/30', 'Payroll — 2 crews of 3', 10800], ['9/15', 'Payroll run', 10800]] },
      { n: 'Materials & plants', a: 10900, tx: [['9/24', 'SiteOne Landscape Supply', 4800], ['9/14', 'Nursery — install job', 3900], ['9/6', 'Mulch — 40 yds', 2200]] },
      { n: 'Equipment & fuel', a: 5200, tx: [['9/27', 'Fuel — trucks + equipment', 2400], ['9/17', 'Mower deck repair', 1100], ['9/5', 'Fuel', 1700]] },
      { n: 'Insurance', a: 2300, tx: [['9/1', 'GL + workers comp + auto', 2300]] },
      { n: 'Dump & disposal fees', a: 1300, tx: [['9/21', 'Green waste facility', 780], ['9/9', 'Green waste facility', 520]] },
      { n: 'Misc & software', a: 2400, tx: [['9/1', 'Route software', 340], ['9/15', 'Equipment lease', 1450], ['9/1', 'Phone & office', 610]] },
    ],
    extraKpi: { k: 'ACTIVE ROUTES', v: '142', sub: 'weekly properties' },
    insights: [
      'Revenue swings 3× between September ($58.9K) and January ($19.8K). Maintenance routes cover about 62% of your winter fixed costs — the installs you book now decide whether January hurts.',
      'Hardscape ran a 39% margin in September vs ~21% on weekly routes. One Whitman-sized patio equals about 3 weeks of route profit.',
  ...
  },
  {
    ...
    expLines: [
      { n: 'Payroll', a: 20400, tx: [['9/30', 'Payroll — 11 cleaners', 10200], ['9/15', 'Payroll run', 10200]] },
      { n: 'Supplies & chemicals', a: 3800, tx: [['9/23', 'Janitorial supply house', 1900], ['9/10', 'Uline — liners & paper', 1200], ['9/3', 'Equipment consumables', 700]] },
      { n: 'Vehicles', a: 2400, tx: [['9/26', 'Fuel', 1100], ['9/12', 'Van insurance', 800], ['9/5', 'Fuel', 500]] },
      { n: 'Insurance & bonding', a: 1900, tx: [['9/1', 'GL + janitorial bond', 1900]] },
      { n: 'Software', a: 900, tx: [['9/1', 'Scheduling + timeclock app', 900]] },
      { n: 'Misc', a: 1800, tx: [['9/18', 'Equipment repair — floor scrubber', 850], ['9/1', 'Office & phone', 950]] },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Subcontractors', a: 92000, tx: [['9/27', 'BlueLine Plumbing — Maple Ave rough-in', 18400], ['9/20', 'Amped Electric — Bayview house', 22800], ['9/13', 'Drywall crew — 3 jobs', 16200]] },
      { n: 'Materials', a: 61400, tx: [['9/25', 'ABC Building Supply', 24600], ['9/16', '84 Lumber — framing package', 19800], ['9/6', 'Window & door order', 11400]] },
      { n: 'Payroll', a: 27800, tx: [['9/30', 'Payroll — field + PM + office', 13900], ['9/15', 'Payroll run', 13900]] },
      { n: 'Equipment rental', a: 6200, tx: [['9/22', 'Excavator — 1 week', 3400], ['9/8', 'Lift rental', 2800]] },
      { n: 'Insurance & bonds', a: 4800, tx: [['9/1', 'GL + builders risk + WC', 4800]] },
      { n: 'Permits & misc', a: 4200, tx: [['9/18', 'Township permits — 2 jobs', 2600], ['9/1', 'Software & office', 1600]] },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Food cost', a: 28600, tx: [['9/26', 'Restaurant Depot', 8400], ['9/19', 'Produce vendor', 3200], ['9/12', 'Cheese & flour distributor', 6800]] },
      { n: 'Payroll', a: 27400, tx: [['9/30', 'Payroll — kitchen + counter + drivers', 13700], ['9/15', 'Payroll run', 13700]] },
      { n: 'Rent', a: 7800, tx: [['9/1', 'Route 37 plaza', 7800]] },
      { n: 'Delivery platform fees', a: 4700, tx: [['9/30', 'DoorDash commission', 2600], ['9/30', 'Uber Eats commission', 1500], ['9/30', 'Slice fees', 600]] },
      { n: 'Utilities', a: 2900, tx: [['9/14', 'Electric — ovens + walk-in', 1900], ['9/8', 'Gas', 1000]] },
      { n: 'Supplies & misc', a: 2900, tx: [['9/21', 'Boxes & packaging', 1400], ['9/1', 'POS + software', 620], ['9/9', 'Hood cleaning', 880]] },
    ],
    extraKpi: { k: 'FOOD COST', v: '32.4%', sub: 'target: under 33%' },
    insights: [
      'Delivery apps took $4,700 in September — 11.3% of delivery revenue. Moving just 15% of app orders to direct ordering (box flyers, QR reorder cards) is ~$700/month straight to profit.',
    ...
    extras: [
      {
        ...
        modules: [{
          ...
          segs: [
            { name: 'DINE-IN', hot: true, lines: [['Orders (Sep)', '1,180'], ['Avg ticket', '$29.10'], ['Platform fees', '$0']], foot: ['Profit / order', '$6.10'] },
            { name: 'TAKEOUT DIRECT', lines: [['Orders (Sep)', '820'], ['Avg ticket', '$26.40'], ['Platform fees', '$0']], foot: ['Profit / order', '$5.40'] },
            { name: 'DOORDASH', lines: [['Orders (Sep)', '610'], ['Avg ticket', '$34.20'], ['Fees / order', '($4.90)']], foot: ['Profit / order', '$2.80'] },
            { name: 'UBER EATS', lines: [['Orders (Sep)', '205'], ['Avg ticket', '$33.10'], ['Fees / order', '($4.60)']], foot: ['Profit / order', '$2.90'] },
          ],
        ...
        modules: [
          {
            ...
            rows: [
              ['Sep 1–7', '$21,400', '$6,810', '31.8%', '33%', { f: 'HIT', tone: 'green' }],
              ['Sep 8–14', '$20,800', '$7,090', '34.1%', '33%', { f: 'MISS', tone: 'red' }],
              ['Sep 15–21', '$22,600', '$7,230', '32.0%', '33%', { f: 'HIT', tone: 'green' }],
              ['Sep 22–28', '$23,600', '$7,650', '32.4%', '33%', { f: 'HIT', tone: 'green' }],
            ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Product (COGS)', a: 82600, tx: [['9/24', 'Fedway Associates', 31200], ['9/17', 'Allied Beverage', 26800], ['9/10', 'Beer distributor', 14200]] },
      { n: 'Payroll', a: 8900, tx: [['9/30', 'Payroll — 4 part-time + manager', 4450], ['9/15', 'Payroll run', 4450]] },
      { n: 'Rent', a: 4200, tx: [['9/1', 'Bayview shopping center', 4200]] },
      { n: 'Insurance', a: 1300, tx: [['9/1', 'Liquor liability + property', 1300]] },
      { n: 'Card fees & misc', a: 1700, tx: [['9/30', 'Card processing', 1250], ['9/1', 'POS + security', 450]] },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Barber commissions', a: 13600, tx: [['9/30', 'Commission payout — 4 chairs', 6800], ['9/15', 'Commission payout', 6800]] },
      { n: 'Rent', a: 3800, tx: [['9/1', 'Main St storefront', 3800]] },
      { n: 'Product cost', a: 2200, tx: [['9/20', 'Pomade & product wholesale', 1400], ['9/6', 'Suavecito order', 800]] },
      { n: 'Supplies', a: 1100, tx: [['9/18', 'Blades, capes, sanitation', 650], ['9/4', 'Towel service', 450]] },
      { n: 'Software & booking', a: 600, tx: [['9/1', 'Booksy + card reader fees', 600]] },
      { n: 'Misc', a: 600, tx: [['9/12', 'Utilities', 380], ['9/1', 'Music licensing + wifi', 220]] },
    ],
    ...
    extras: [
      {
        tab: 'Scoreboard',
        modules: [{
          type: 'board', t: 'Chair scoreboard — September', sub: 'Post it in the back room and watch rebook rates jump',
  ...
  },
  {
    ...
    expLines: [
      { n: 'Inventory (COGS)', a: 21900, tx: [['9/23', 'Market buy — fall preview', 9800], ['9/14', 'Brand rep order — denim', 6400], ['9/5', 'Jewelry & accessories vendor', 5700]] },
      { n: 'Payroll', a: 8200, tx: [['9/30', 'Payroll — 3 part-time + manager', 4100], ['9/15', 'Payroll run', 4100]] },
      { n: 'Rent', a: 4600, tx: [['9/1', 'Downtown Main St', 4600]] },
      { n: 'Shopify & card fees', a: 1500, tx: [['9/30', 'Card processing', 980], ['9/1', 'Shopify + apps', 520]] },
      { n: 'Marketing', a: 900, tx: [['9/16', 'Instagram ads', 600], ['9/2', 'Email platform', 300]] },
      { n: 'Misc', a: 700, tx: [['9/10', 'Bags & packaging', 420], ['9/1', 'Utilities & wifi', 280]] },
    ],
    extraKpi: { k: 'AVG SALE', v: '$68', sub: 'in-store · $84 online' },
    insights: [
      'Dresses are 28% of September revenue at a 54% margin — they carry the store. The sale rack runs half that margin; keep it to one rack in the back.',
      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            segs: [
              { name: 'IN-STORE', lines: [['Sales (Sep)', '$29,800'], ['Avg sale', '$68'], ['Rent + staff share', '($9,400)']], foot: ['Channel margin', '22%'] },
              { name: 'ONLINE', hot: true, lines: [['Sales (Sep)', '$12,400'], ['Avg sale', '$84'], ['Fees + shipping', '($1,830)']], foot: ['Channel margin', '25%'] },
            ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Payroll & trainers', a: 19800, tx: [['9/30', 'Payroll — staff + trainer splits', 9900], ['9/15', 'Payroll run', 9900]] },
      { n: 'Rent', a: 9800, tx: [['9/1', '12,000 sq ft — industrial park', 9800]] },
      { n: 'Equipment & maintenance', a: 3600, tx: [['9/22', 'Treadmill belt + service call', 1400], ['9/8', 'Plate & dumbbell replacement', 2200]] },
      { n: 'Utilities', a: 2700, tx: [['9/14', 'Electric — HVAC heavy', 2100], ['9/8', 'Water & sewer', 600]] },
      { n: 'Insurance', a: 1600, tx: [['9/1', 'GL + participant liability', 1600]] },
      { n: 'Software & misc', a: 2100, tx: [['9/1', 'Gym management software', 480], ['9/30', 'Card processing on dues', 1120], ['9/1', 'Music + streaming licenses', 500]] },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Payroll — hygienists & staff', a: 46200, tx: [['9/30', 'Payroll — 2 hygienists, 3 front/back', 23100], ['9/15', 'Payroll run', 23100]] },
      { n: 'Supplies & lab fees', a: 21400, tx: [['9/24', 'Crown & bridge lab', 9200], ['9/15', 'Henry Schein order', 8400], ['9/5', 'Implant components', 3800]] },
      { n: 'Rent', a: 9600, tx: [['9/1', 'Medical plaza suite', 9600]] },
      { n: 'Equipment leases', a: 6400, tx: [['9/1', 'CBCT + chairs lease', 4600], ['9/1', 'Cerec milling lease', 1800]] },
      { n: 'Malpractice & insurance', a: 4100, tx: [['9/1', 'Malpractice premium', 3200], ['9/1', 'Office policy', 900]] },
      { n: 'Software & misc', a: 5100, tx: [['9/1', 'Practice management + imaging', 1900], ['9/30', 'Card & financing fees', 1800], ['9/12', 'Marketing — new patient ads', 1400]] },
    ],
    ...
    insights: [
      ...
      'Cosmetic is 13% of revenue, best margin, zero insurance friction. With 38 new patients in September, every cosmetic case accepted adds ~$2K average.',
    ],
    extras: [
      {
        tab: 'Treatment List',
  ...
  },
  {
    ...
    expLines: [
      { n: 'Attorney & staff payroll', a: 68400, tx: [['9/30', 'Payroll — 3 attorneys, 2 paralegals, admin', 34200], ['9/15', 'Payroll run', 34200]] },
      { n: 'Rent', a: 11200, tx: [['9/1', 'Class A office — Hooper Ave', 11200]] },
      { n: 'Malpractice insurance', a: 4900, tx: [['9/1', 'Professional liability premium', 4900]] },
      { n: 'Research & filing fees', a: 4300, tx: [['9/1', 'Westlaw subscription', 2400], ['9/19', 'Court filing fees', 1100], ['9/8', 'Process servers', 800]] },
      { n: 'Marketing', a: 3800, tx: [['9/15', 'Google ads — estate planning', 2400], ['9/1', 'SEO retainer', 1400]] },
      { n: 'Office & misc', a: 5600, tx: [['9/1', 'Practice management software', 1200], ['9/30', 'Card & trust account fees', 1600], ['9/12', 'CLE + bar dues', 2800]] },
    ],
    ...
    insights: [
      ...
      'Realization at 91% means ~$14K of September\'s work went unbilled or written down — and the write-downs cluster on flat-fee matters. Reprice those; don\'t discount hourly.',
      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            segs: [
              { name: 'HOURLY', lines: [['Worked (Sep)', '$92,600'], ['Billed', '$88,900'], ['Written down', '($3,700)']], foot: ['Realization', '96%'] },
              { name: 'FLAT-FEE', hot: true, lines: [['Worked (Sep)', '$38,400'], ['Billed', '$30,200'], ['Written down', '($8,200)']], foot: ['Realization', '79%'], footTone: 'red' },
              { name: 'RETAINER DRAW', lines: [['Worked (Sep)', '$17,400'], ['Billed', '$17,400'], ['Written down', '$0']], foot: ['Realization', '100%'] },
            ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Payroll', a: 38400, tx: [['9/30', 'Payroll — PMs + leasing + office', 19200], ['9/15', 'Payroll run', 19200]] },
      { n: 'Maintenance techs & contractors', a: 18600, tx: [['9/24', 'HVAC contractor — 4 units', 6800], ['9/16', 'In-house tech payroll', 8400], ['9/9', 'Plumbing calls ×6', 3400]] },
      { n: 'Office rent', a: 5400, tx: [['9/1', 'Office suite', 5400]] },
      { n: 'Software', a: 2800, tx: [['9/1', 'AppFolio', 2100], ['9/1', 'Screening & marketing tools', 700]] },
      { n: 'Insurance', a: 2400, tx: [['9/1', 'E&O + GL', 2400]] },
      { n: 'Misc', a: 4300, tx: [['9/20', 'Legal — eviction filings ×2', 1900], ['9/30', 'Mileage + phones', 1400], ['9/1', 'Owner portal & banking fees', 1000]] },
    ],
    ...
    ops: {
      ...
      kpis: [{ k: 'COLLECTED (MTD)', v: '96.2%', sub: 'of September rent roll' }, { k: 'DELINQUENT', v: '$18,400', sub: '11 tenants' }, { k: 'VACANCY', v: '3.9%', sub: '11 of 284 doors' }],
      rows: [
  ...
  },
  {
    ...
    expLines: [
      { n: 'Product cost', a: 28400, tx: [['9/22', 'Supplier PO #1148 — candles', 14200], ['9/12', 'Packaging supplier', 4800], ['9/4', 'Supplier PO #1141 — bath line', 9400]] },
      { n: 'Shipping & fulfillment', a: 11200, tx: [['9/30', 'ShipStation — USPS/UPS labels', 7400], ['9/30', 'Amazon FBA fees', 3800]] },
      { n: 'Ads (Meta & Google)', a: 9800, tx: [['9/30', 'Meta ads', 6200], ['9/30', 'Google Shopping', 3600]] },
      { n: 'Payroll', a: 5400, tx: [['9/30', 'Payroll — 2 part-time packers', 2700], ['9/15', 'Payroll run', 2700]] },
      { n: 'Software & fees', a: 2100, tx: [['9/1', 'Shopify + apps', 780], ['9/30', 'Card processing', 1320]] },
      { n: 'Misc', a: 1400, tx: [['9/1', 'Storage unit', 900], ['9/16', 'Photography props', 500]] },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Driver pay', a: 78600, tx: [['9/30', 'Driver settlements — 8 drivers', 39300], ['9/15', 'Driver settlements', 39300]] },
      { n: 'Fuel', a: 52400, tx: [['9/28', 'Fleet fuel card — week 4', 13800], ['9/21', 'Fleet fuel card — week 3', 12900], ['9/14', 'Fleet fuel card — week 2', 13200]] },
      { n: 'Maintenance & tires', a: 21800, tx: [['9/24', 'Truck 4 — clutch + PM service', 8900], ['9/16', 'Steer tires ×4 — truck 7', 4200], ['9/9', 'Trailer brake job', 3800]] },
      { n: 'Insurance', a: 14600, tx: [['9/1', 'Liability + cargo + physical damage', 14600]] },
      { n: 'Truck payments', a: 12400, tx: [['9/1', 'Equipment finance — 4 notes', 12400]] },
      { n: 'Tolls & misc', a: 5000, tx: [['9/30', 'EZ-Pass fleet', 3200], ['9/1', 'ELD + dispatch software', 1100], ['9/18', 'Permits', 700]] },
    ],
    ...
    insights: [
      ...
      'Truck 4: 6 days down in September, $8.9K in repairs, ~$14K total swing with lost loads. At this rate, replacing it beats repairing it within 3 quarters.',
    ],
    extras: [
      {
        tab: 'Truck P&L',
        modules: [{
          ...
          note: 'Truck 4 LOST $5K in September with no payment on it. A $2,150/month note on a new unit beats an $8,900 repair month every time — now the math is on one line.',
        }],
      },
      {
        tab: 'Lanes & Fuel',
        modules: [
          ...
          },
          {
            ...
            rows: [
              ['Sep 1–7', '3,180', '$3.89', '$12,370', '$3,720', '($680)'],
              ['Sep 8–14', '3,240', '$3.96', '$12,830', '$3,780', '($910)'],
              ['Sep 15–21', '3,150', '$4.04', '$12,730', '$3,810', '($1,050)'],
              ['Sep 22–28', '3,290', '$4.01', '$13,190', '$4,240', '($720)'],
            ],
            note: 'Your surcharge schedule lags the pump by about two weeks — that gap was $3,360 in September. Reset the schedule monthly, not quarterly.',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    expLines: [
      { n: 'Product (COGS)', a: 131800, tx: [['9/25', 'Manufacturer PO — dry goods', 48200], ['9/18', 'Importer — specialty lines', 39400], ['9/11', 'Manufacturer PO — beverages', 32800]] },
      { n: 'Warehouse payroll', a: 15400, tx: [['9/30', 'Payroll — warehouse + drivers', 7700], ['9/15', 'Payroll run', 7700]] },
      { n: 'Trucks & fuel', a: 8900, tx: [['9/27', 'Fleet fuel', 3900], ['9/14', 'Box truck lease ×3', 3600], ['9/7', 'Reefer unit service', 1400]] },
      { n: 'Warehouse rent', a: 4800, tx: [['9/1', '18,000 sq ft + dock', 4800]] },
      { n: 'Insurance', a: 2200, tx: [['9/1', 'Cargo + GL + auto', 2200]] },
      { n: 'Misc', a: 1800, tx: [['9/1', 'Inventory software + scanners', 900], ['9/20', 'Pallets & shrink wrap', 900]] },
    ],
...
export const EXISTING_DEMOS = [
  { href: '/demo', biz: 'Riverside Bakery', industry: 'Bakery & Café', emoji: '🥐', blurb: 'Daily sales, food cost, and profit across locations — the original dashboard pattern.' },
  { href: '/riverside-tires', biz: 'Riverside Tires', industry: 'Tires & Auto Service', emoji: '🔩', blurb: 'Register tickets matched to distributor invoices — margin per repair order live.' },
  { href: '/riverfall-gowns', biz: 'Riverfall Gowns', industry: 'Gowns & Bridal Retail', emoji: '👗', blurb: 'Custom orders with deposits, alterations queue, and balances — owner and staff views.' },
  { href: '/appliance-repair', biz: 'YT Appliance Repair', industry: 'Appliance Repair', emoji: '🔧', blurb: 'Open job board — parts, labor, and profit per ticket as the day moves.' },
  { href: '/sba-lending', biz: 'Riverbank Funding', industry: 'Business Lending', emoji: '🏦', blurb: 'Deal pipeline from lead to disbursed — fees and portfolio on one screen.' },
  { href: '/riverstone-roofing', biz: 'Riverstone Roofing', industry: 'Commercial Roofing', emoji: '🏘️', blurb: 'Job margin flags, WIP schedule, claim-aware cash flow, and a print-ready buyer package.' },
  { href: '/riverbend-fence', biz: 'Riverbend Fence Co.', industry: 'Fencing & Trade Contracting', emoji: '🪵', blurb: 'Field crew logs a day from a phone — coded to the job in QuickBooks.' },
  { href: '/ar-desk', biz: 'Lakeland Supply Co.', industry: 'AR & Collections', emoji: '📬', blurb: 'Open invoices pulled from QuickBooks — bulk statements from your own mailbox.' },
  { href: '/harborfield-properties', biz: 'Harborfield Residential', industry: 'Property Management', emoji: '🏠', blurb: 'Rent roll, delinquency tracking, and owner statements — one portal for the whole portfolio.' },
  { href: '/northline-global', biz: 'Northline Global', industry: 'Import & Distribution', emoji: '📦', blurb: 'PO pipeline with landed cost, warehouse bin lookup, and margin on every order.' },
]
