...
export const EXISTING_DEMOS = [
  ...
  { href: '/riverstone-roofing', biz: 'Riverstone Roofing', industry: 'Commercial Roofing', emoji: '🏘️', blurb: 'Job margin flags, WIP schedule, claim-aware cash flow — and a buyer package.' },
  { href: '/riverbend-fence', biz: 'Riverbend Fence Co.', industry: 'Fencing & Trade Contracting', emoji: '🪵', blurb: 'The crew logs a day in ten seconds — and it lands in QuickBooks coded to the job.' },
